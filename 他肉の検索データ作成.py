...
#出力ファイル
out_name = ('C:/xampp/htdocs/niku/他肉のランキング.txt')


#入力ファイル　部位のサーチ数を数える
fname = ('C:/xampp/htdocs/niku/元キーワード他肉ランキング.txt')
...
for l_data in bui_data:
    ...
    url = 'https://app.rakuten.co.jp/services/api/IchibaItem/Search/20170706?applicationId=1093881737175375236&keyword=' + s_quote + '&genreId=100228&format=xml'
    r = requests.get(url)
