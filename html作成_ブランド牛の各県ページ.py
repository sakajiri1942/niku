...
copy_moto = 'C:/ACES WEB/SIRIUS/サイト生成先/肉のサイト/beef_brand/beef_brand_〇kenmei.php'
f = open(copy_moto, 'r', encoding="utf-8")
cpmoto_data = f.read()
f.close()

outfile_path = 'C:/xampp/htdocs/niku/niku-site/beef_brand/'
...
for l_b_data in b_data:
    ...
    # bangou = str(b)
    fname_ken_kobetu = 'beef_brand_' + ken_inf[1] + '_' + ken_inf[3] + '.php'
    ...
    if ken_inf[1] not in ken_inf_tugi[1]:
        ...
        for l_gyou_inf in gyou_inf:
            ...
            # beef_brand_hokkaidou_hokkaidouohotukuabasiriwagyu
            mottomiru = "<h6><a href=\"./beef_brand_" + tango_inf[1] + "_" + tango_inf[3] + ".php\">" + tango_inf[
                2] + "のページへ</a></h6>"
