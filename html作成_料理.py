...
copy_moto = 'C:/ACES WEB/SIRIUS/サイト生成先/肉のサイト/beef_ryouri/index.php'
f = open(copy_moto, 'r', encoding="utf-8")
cpmoto_data = f.read()
f.close()
#beef_bui_〇bui.php

copy_moto_kobetu = 'C:/ACES WEB/SIRIUS/サイト生成先/肉のサイト/beef_ryouri/beef_ryouri_〇ryouri.php'
f = open(copy_moto_kobetu, 'r', encoding="utf-8")
cpmoto_data_kobetu = f.read()
f.close()


outfile_path = 'C:/xampp/htdocs/niku/niku-site/beef_ryouri/index.php'
outfile_path_kobetu = 'C:/xampp/htdocs/niku/niku-site/beef_ryouri/'
...
for l_b_data in b_data:
    ...
    if '料理' in l_b_data:
        ...
        #naiyou_all = '書き換え'
        naiyou_all = naiyou_all + '<h6><a href=./beef_ryouri_'+bui_inf[2]+'.php>' + bui_inf[0] + 'の一覧を見る</a></h6>'
        ...
        cpmoto_data_kobetu2 = cpmoto_data_kobetu2.replace('〇料理', bui_inf[0])
        #上記の変数を流用
        ...
        outfile_path_kobetu2 = outfile_path_kobetu+'beef_ryouri_'+bui_inf[2]+'.php'
